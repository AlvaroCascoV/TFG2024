...
<body>
	...
	<h1>Tienda Online</h1>
        ...
        <div> 
			...
			<button onclick="addToCart('Ciruela roja', 4.50)">Agregar al Carrito</button>
		</div>
		...
		<div>
			...
			<button onclick="addToCart('Frambuesa', 3.50)">Agregar al Carrito</button>
		</div>
		...
		<div>
			...
			<button onclick="addToCart('Kiwi verde', 5.50)">Agregar al Carrito</button>
		</div>
		...
		<div>
			...
			<button onclick="addToCart('Lima', 6.50)">Agregar al Carrito</button>
		</div>
		...
		<div>
			...
			<button onclick="addToCart('Limón', 3.50)">Agregar al Carrito</button>
		</div>
		...
		<div>
			...
			<button onclick="addToCart('Mandarina', 3.50)">Agregar al Carrito</button>
		</div>
		<div>
			...
			<button onclick="addToCart('Manzana golden', 4.50)">Agregar al Carrito</button>
		</div>
		<div>
			<h2>Manzana Story</h2>
			...
			<button onclick="addToCart('Manzana Story', 3.50)">Agregar al Carrito</button>
		</div>
		...
		<div>
			...
			<button onclick="addToCart('Naranja de mesa', 3.50)">Agregar al Carrito</button>
		</div>
		...
		<div>
			...
			<button onclick="addToCart('Plátano de canarias', 3.50)">Agregar al Carrito</button>
		</div>
