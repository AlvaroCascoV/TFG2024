...
<body>
	...
	<form action="cart.php" method="post">
		...
		<input type="number" id="cantidad39" name="cantidad39" value="0">

        <h2>Plátano de canarias</h2>
		<img src="platano-de-canarias.png" alt="Producto 40">
		<p>Precio: 3.50€ / kg</p>
		<label for="cantidad40">Cantidad:</label>
		<input type="number" id="cantidad40" name="cantidad40" value="0">
